...
/* Set argument */
void RomXML::SetArgument(const char* argument)
{
...
/* Get name */
const char * RomXML::GetName() const
{
	return Name.c_str();
}

/* Set Name */
void RomXML::SetName(char * newName)
{
	Name = newName;
}

/* Get coder */
const char * RomXML::GetCoder() const
{
	return Coder.c_str();
}

/* Get version */
const char * RomXML::GetVersion() const
{
	return Version.c_str();
}

/* Set version */
void RomXML::SetVersion(const char * newVer)
{
	Version = newVer;
}

/* Get releasedate */
const char * RomXML::GetReleasedate() const
{
	return Releasedate.c_str();
}

/* Get shortdescription */
const char * RomXML::GetShortDescription() const
{
	return ShortDescription.c_str();
}

/* Get longdescription */
const char * RomXML::GetLongDescription() const
{

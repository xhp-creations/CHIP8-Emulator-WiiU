...
public:
    ...
    void loadGDImage(gdImagePtr gdImg);  // function added to change texture with new gd image
    void loadBufImage();  // function added to change texture with new u32* colorbuffer
    //! getter functions
